#!/usr/bin/env python3
"""
Test with header logging to see what's happening.
"""
import asyncio
import json
import uuid
...
async def test_with_header_logging():
    """Test with header logging."""
    print("Testing with header logging...")
...
if __name__ == "__main__":
    tool_count = asyncio.run(test_with_header_logging())
