...
# Add re import and cleaning functions after existing imports
old_imports = '''import tempfile
import subprocess

logger = logging.getLogger(__name__)'''

new_imports = '''import tempfile
import subprocess
import re
