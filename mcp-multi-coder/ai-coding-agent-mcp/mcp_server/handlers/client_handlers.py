...
class ClientMethodsHandlers:
    ...
    async def handle_sampling_complete(self, params: Dict[str, Any], request_id: str) -> Dict[str, Any]:
        """
    ...
    async def handle_elicitation_request(self, params: Dict[str, Any], request_id: str) -> Dict[str, Any]:
        """
    ...
    async def handle_logging_message(self, params: Dict[str, Any], request_id: str) -> Dict[str, Any]:
        """
